...
class TestSimpleUtils:
    def test_create_header_text(self):
        ...
        assert ("This is a fax generated by the Kansas City, "
                "Missouri Health Department's FaxVax Service. If you "
                "have any questions fulfiling it, please contact us "
                "at __________.") in string_body


class TestMethod__make_faxio_request:
    def test_it_makes_a_valid_call(self):
        info_dict = {}
        ...
        info_dict['header_text'] = ("TESTING")
        # info_dict['header_text'] = ("This is a fax generated by the Kansas "
        #                             "City, Missouri Health Department's FaxVax "
        #                             "Service. If you have any questions "
        #                             "fulfiling it, please contact us at "
        #                             "__________.")
        info_dict['tag[request_id]'] = str(random.randint(1, 1000))
        request = make_faxio_request(info_dict)
